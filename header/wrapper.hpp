...
// - - - - - - - - - - - - - - - - - - - - - - - -
std::vector<double> get_result_step_attempts_1x1();
std::vector<double> get_result_step_attempts_2x2();
// - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - -
std::vector<unsigned long> m_step_attempt_results_1x1;
std::vector<unsigned long> m_step_attempt_results_2x2;
//
std::vector<unsigned long> m_wtd_1x1;
std::vector<unsigned long> m_wtd_2x2;
// - - - - - - - - - - - - - - - - - - - - - - - -
// for counting series of steps with length 2/3/4 for 1x1/2x2 tracers, sorted by directions
