...
int main(int ac, char** av){
        ...
        Wrapper * wrapper = new Wrapper(rng_seed ? rng_seed : rd(),
                                        number_of_lattices,
                                        grid_size,
                                        number_of_timesteps,
                                        number_of_timesteps_warmup,
        ...
        {
                vector_to_file(wrapper->get_result_lsq_1x1(),       "msd_1x1_"+output_fname_base);
                vector_to_file(wrapper->get_result_rate_1x1(),      "rat_1x1_"+output_fname_base);
                vector_to_file(wrapper->get_result_step_corr_1x1(), "stp_1x1_"+output_fname_base);
                vector_to_file(wrapper->get_result_site_corr_1x1(), "sit_1x1_"+output_fname_base);
                vector_to_file(wrapper->get_result_pos_1x1(),       "pos_1x1_"+output_fname_base);
        }
        /* = = = = = = = = = = = = = = = = = = = = = = = = = = = = */
        if(number_of_tracers_2x2)
        {
                vector_to_file(wrapper->get_result_lsq_2x2(),       "msd_2x2_"+output_fname_base);
                vector_to_file(wrapper->get_result_rate_2x2(),      "rat_2x2_"+output_fname_base);
                vector_to_file(wrapper->get_result_step_corr_2x2(), "stp_2x2_"+output_fname_base);
                vector_to_file(wrapper->get_result_site_corr_2x2(), "sit_2x2_"+output_fname_base);
                vector_to_file(wrapper->get_result_pos_2x2(),       "pos_2x2_"+output_fname_base);
        }
