...
Wrapper::Wrapper(int number_of_lattices,
        ...
        m_this_number_of_tracers_1x1_times_number_of_lattices((double)(number_of_tracers_1x1*number_of_lattices)),
        m_this_number_of_tracers_2x2_times_number_of_lattices((double)(number_of_tracers_2x2*number_of_lattices)),
        m_this_number_of_tracers_3x3_times_number_of_lattices((double)(number_of_tracers_3x3*number_of_lattices)),
...
double Wrapper::get_avg_rate_1x1(){
        ...
        return (double)tmp_sum/(this->m_t+1)/this->m_this_number_of_tracers_1x1_times_number_of_lattices;
}
double Wrapper::get_avg_rate_2x2(){
        ...
        return (double)tmp_sum/(this->m_t+1)/this->m_this_number_of_tracers_2x2_times_number_of_lattices;
}
double Wrapper::get_avg_rate_3x3(){
        ...
        return (double)tmp_sum/(this->m_t+1)/this->m_this_number_of_tracers_3x3_times_number_of_lattices;
}
// = = = = = = = = = = = = = = = = = = = = = = = = =
